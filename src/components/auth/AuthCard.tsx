...
export function AuthCard({ onAuthSuccess }: AuthCardProps) {
  ...
  const handleEmailSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("[handleEmailSubmit] Submitting email...");
    ...
    try {
      ...
      console.log("[handleEmailSubmit] FormData email:", formData.get("email"));
  
      await signIn("resend-otp", formData);
  
      console.log("[handleEmailSubmit] signIn email success ✅");
  
      setStep({ email: formData.get("email") as string });
      setIsLoading(false);
    } catch (error) {
      console.error("[handleEmailSubmit] Email sign-in error ❌:", error);
  ...
  const handleOtpSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    console.log("[handleOtpSubmit] Submitting OTP...");
