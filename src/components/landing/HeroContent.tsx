    ...
    <div>
      ...
      <div style={{fontFamily: 'Poppins'}}>
        <div style={{margin: 9, display: "flex", flexDirection: "column", width: "100%", justifyContent: "center", alignItems: "center"}}>
          ...
          <p style={{fontSize: "100px", marginTop: "300px", fontWeight:"900"}}>
        ...
        <div style={{ display: "flex", gap: "20px", justifyContent: "center", flexGrow: 1, textAlign:"center", alignItems: "center", fontSize:"18px", paddingTop:"10px"}}>
